...
Public Class frmconsultaLetrasFecha
    ...
    Private Sub btnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        ...
        Try
            ...
            swEscritor.WriteLine("      R e p o r t e  d e  C u e n t a s  x  C o b r a r - O r d e n a d o  x  F e c h a  E m i s i o n")
            swEscritor.WriteLine(" ")
            swEscritor.WriteLine("Cuotas vencidas al " & Me.dtpFechaLiquidacion.Text & "                                        fecha reporte: " & DateTime.Today)
            swEscritor.WriteLine("-------------------------------------------------------------------------------------------------------------")
            swEscritor.WriteLine("Núm.Letra      Corr. Mon. Importe  MN    Importe  ME Amortizacion  Saldo     Fecha Emis.    Fecha Venc.      ")
            swEscritor.WriteLine("-------------------------------------------------------------------------------------------------------------")

            Connection.Open()
            Dim daLetrasClientes As New SqlDataAdapter("SELECT *FROM letrasClientes where fecVencimiento<= '" & Me.dtpFechaLiquidacion.Text & "'  and ((numRecibo=' ' and status=' ') or (numRecibo<>' ' and status='A')) order by fecEmision", Connection)
            ...
            swEscritor.WriteLine("Resumen total x anos menos amortizaciones")
