...
Public Class frmkardexProducto
    ...
    Private Sub btnProcesar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProcesar.Click
        ...
        Try
            ...
            Dim daVtaDetalle As SqlDataAdapter = New SqlDataAdapter("SELECT tipDocumento,serDocumento,numDocumento,cantidad,fecOperacion FROM vtaDetalle where fecOperacion>='" & CDate(Me.dtpFechaInicio.Text) & "' and fecOperacion<='" & CDate(Me.dtpFechaLimite.Text) & "' and idProducto=" & CInt(txtProducto.Text) & "", Connection)
