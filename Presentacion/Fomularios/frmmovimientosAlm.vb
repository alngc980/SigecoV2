...
Public Class frmmovimientosAlm
    Private oDataSet As DataSet
    Dim te As New RichTextBox
    Dim ctaFilas As Integer
    Private Sub frmmovimientosAlm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Controls.Add(te)
    ...
    Private Sub btnProcesar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProcesar.Click
        ...
        Try
            ...
            Dim daAlmCabecera As New SqlDataAdapter("SELECT *FROM almCabecera where fecOrigen='" & CDate(dtpFechaLiquidacion.Text) & "' and status<>'A'", Connection)
            ...
            For i As Integer = 0 To oDataSet.Tables(3).Rows.Count() - 1
                ...
                oDataRow1(9) = Me.oDataSet.Tables(5).Rows(i).Item(1)
                oDataRow1(10) = Me.oDataSet.Tables(5).Rows(i).Item(2)
                oDataRow1(11) = Me.oDataSet.Tables(5).Rows(i).Item(3)
                'Exit For
                'End If
                'Next x
            Next i
    ...
    Private Sub btnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        Try
            If ctaFilas > 0 Then
                ...
                te.Text = te.Text & "                                                    MOVIMIENTO DIARIO ALMACEN " & Me.dtpFechaLiquidacion.Text & enter & enter
                te.Text = te.Text & "------------------------------------------------------------------------------------------------------------------------------------------------------------" & enter
                te.Text = te.Text & "Item Descripción                  Marca            Modelo         N° Serie             N° Motor             Cliente/Proveedor         N° Docum.  Cantidad  " & enter
                ...
                For i As Integer = 0 To oDataSet.Tables(3).Rows.Count() - 1
                    ...
                    te.Text = te.Text & i + 1 & Space(3 - Len(Str(i + 1))) & " "
                    te.Text = te.Text & VisualBasic.Left(Me.oDataSet.Tables(3).Rows(i).Item(6), 30) & Space(30 - Len(VisualBasic.Left(Me.oDataSet.Tables(3).Rows(i).Item(6), 30))) & " "
