...
Public Class frmnotaCreditoCambio
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            If Me.oDataSet.Tables(4).Rows.Count >= 1 Then Me.numReciboAdelanto = Me.oDataSet.Tables(4).Rows(0).Item(12) & Me.oDataSet.Tables(4).Rows(0).Item(9)
            Connection.Close()
            ...
            For x As Integer = 0 To oDataSet.Tables(2).Rows.Count() - 1
                ...
                Me.dgvProductos.Rows(x).Cells(2).Value = Me.oDataSet.Tables(2).Rows(x).Item(10)
    ...
    Private Sub btnProcesar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProcesar.Click
        ...
        Try
            ...
            If MsgBox("Está seguro de aplicar nota de crédito a este documento?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                ...
                Me.cbxTipoVenta.SelectedIndex & "','" & Me.txtStringNumDocumento & "'," & Me.codigoCliente & "," & Me.txtTotalPagar.Text & "," & _
                Me.txtTotalPagarME.Text & "," & Me.txtInteres.Text & "," & Me.txtIGV.Text & ",'" & Me.dtpFechaVcmto.Text & "'," & _
