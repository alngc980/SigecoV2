Public Class frmnuevoVendedor
    Dim SqlString1 As String = "SELECT *FROM vendedores"
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        Try
            ...
            If (Me.txtPaterno.Text <> "" And Me.txtMaterno.Text <> "" And Me.txtNombre.Text <> "" And Me.txtDNI.Text <> "" And Me.txtCelular.Text <> "") Then
                ...
                SqlString = "INSERT INTO vendedores (apePaterno,apeMaterno,nombres,direccion,dni,telCelular,telFijo,cargo,fecAlta) VALUES ('" & _
                ...
                If grabarSqlString(SqlString) Then
                    ...
                    arrayDatos(0) = Me.txtCodigoVendedor.Text
                ...
                End If
            Else
                MsgBox("Faltan datos del vendedor.", MsgBoxStyle.Critical)
            End If
