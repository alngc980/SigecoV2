...
Public Class frmreporteVentasTodoMes
    ...
    Private Sub frmreporteVentasTodoMes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            For i As Integer = 0 To oDataSet.Tables(1).Rows.Count() - 1
                If Me.oDataSet.Tables(1).Rows(i).Item(12) > 1 Then
                    If Me.oDataSet.Tables(1).Rows(i).Item(12) = 2 Then
                        ...
                        If Me.oDataSet.Tables(2).Rows(y).Item(0) = Me.oDataSet.Tables(0).Rows(x).Item(0) And _
                           Me.oDataSet.Tables(2).Rows(y).Item(2) = Me.oDataSet.Tables(0).Rows(x).Item(2) Then
                            ...
                            If Me.oDataSet.Tables(0).Rows(x).Item(4) <> 10 Then
                                texto.Text = texto.Text & Me.oDataSet.Tables(2).Rows(y).Item(10).ToString.PadRight(30)
                            Else
    ...
    End Sub
    Private Sub cbxAnno_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbxAnno.SelectedValueChanged
        ctaFilasVentas = 0
        ctaFilasNotas = 0
    End Sub
    Private Sub cbxMes_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbxMes.SelectedValueChanged
        ctaFilasVentas = 0
        ctaFilasNotas = 0
    End Sub
    Private Sub cbxMoneda_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbxMoneda.SelectedValueChanged
        ctaFilasVentas = 0
        ctaFilasNotas = 0
    End Sub
