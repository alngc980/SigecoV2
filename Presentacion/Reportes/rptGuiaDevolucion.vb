...
Public Class rptGuiaDevolucion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.rptGuiaDevolucion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGuiaDevolucion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiaDevolucion = New rptGuiaDevolucion()
        rpt.Site = Me.Site
        Return rpt
    End Function
